...
export class Gikusai20241029Stack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // matching/list
    const MatchingListLambda = new lambda.Function(this, "MatchingListLambdaFunction", {
      runtime: lambda.Runtime.PYTHON_3_11,
    ...
    // matching/list
    const MatchingMatchLambda = new lambda.Function(this, "MatchingMatchLambdaFunction", {
      runtime: lambda.Runtime.PYTHON_3_11,
    ...
    matchingListResource.addMethod("GET", new apigateway.LambdaIntegration(MatchingListLambda)); // POSTメソッドを追加
    matchingListResource.addMethod("OPTIONS", new apigateway.MockIntegration({
      integrationResponses: [{
        statusCode: "200",
        responseParameters: {
          "method.response.header.Access-Control-Allow-Origin": "'*'",
    ...
    matchingMatchResource.addMethod("GET", new apigateway.LambdaIntegration(MatchingMatchLambda)); // POSTメソッドを追加
    matchingMatchResource.addMethod("OPTIONS", new apigateway.MockIntegration({
      integrationResponses: [{
        statusCode: "200",
        responseParameters: {
          "method.response.header.Access-Control-Allow-Origin": "'*'",
